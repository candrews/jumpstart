...
1. Allow static content changes to appear instance without requiring an application restart (See [http://stackoverflow.com/a/35895848/791247](http://stackoverflow.com/a/35895848/791247) for details)
   1. Search all IntelliJ actions (Command + Shift + A) for “Registry” and click the first result
   1. Lookup "compiler.automake.allow.when.app.running" and enable it.
